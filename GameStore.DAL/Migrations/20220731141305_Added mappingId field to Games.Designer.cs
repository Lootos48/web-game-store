...
namespace GameStore.DAL.Migrations
{
    ...
    [Migration("20220731141305_Added mappingId field to Games")]
    partial class AddedmappingIdfieldtoGames
    {
            ...
            modelBuilder.Entity("GameStore.DAL.Entities.GoodsProductMappingEntity", b =>
                {
                    b.HasOne("GameStore.DAL.Entities.GameEntity", "Game")
                        .WithOne("Mappings")
                        .HasForeignKey("GameStore.DAL.Entities.GoodsProductMappingEntity", "GameId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
